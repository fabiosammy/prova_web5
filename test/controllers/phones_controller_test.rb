...
#       post :create, phone: { default: @phone.default, number: @phone.number, person_id: @phone.person_id }
#     end
...
#     patch :update, id: @phone, phone: { default: @phone.default, number: @phone.number, person_id: @phone.person_id }
#     assert_redirected_to phone_path(assigns(:phone))
#   end
